...
import { z } from "zod";
import { Sparkles, Globe, Eye, EyeOff } from "lucide-react";
...
function LoginForm() {
  ...
  const [error, setError] = useState<string | null>(
    urlError === "OAuthCallback"
      ? "There was a problem signing in with Google. Please make sure the Redirect URI is correct in Google Console."
      : urlError === "OAuthSignin"
      ? "Error starting Google sign-in."
      : null
  );
    ...
    <div className="bg-white rounded-2xl shadow-sm border border-neutral-100 p-8">
      ...
      <div className="space-y-3 mb-6">
        <Button
          type="button"
          variant="outline"
          className="w-full gap-3 h-11 border-neutral-200 hover:bg-neutral-50 hover:border-neutral-300 transition-all font-medium text-neutral-700"
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-rose-50 via-white to-violet-50 px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <Suspense fallback={<div className="bg-white rounded-2xl border border-neutral-100 p-8 animate-pulse h-80" />}>
          <LoginForm />
        </Suspense>
